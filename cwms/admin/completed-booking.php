...
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Completed Bookings</li>
</ol>
...
$sql = "SELECT tblbooking.*, 
        ...
        WHERE LOWER(tblbooking.status) = 'completed' 
...
<tr>
    ...
    <td>
        <a href="booking-details.php?bid=<?php echo htmlentities($result->bid); ?>">View</a>
    </td>
</tr>
<?php } } else { ?>
<tr>
